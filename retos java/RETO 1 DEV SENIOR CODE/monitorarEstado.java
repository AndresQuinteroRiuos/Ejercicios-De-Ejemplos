public class monitorarEstado {
        ...
        // Constructor
        public AvionMonitor(int numeroPasajeros, int cantidadAlimentacion, double combustibleEstable, double proximidadAterrizaje) {
        ...
        public static void main(String[] args) {
            // Ejemplo de uso
            AvionMonitor avion = new AvionMonitor(150, 300, 5000.0, 50.0);
